...
class TripleConv(Layer):
    def __init__(self, channels, kernel_size, stride, weights_normalization=None, normalization=None, activation=None):
        ...
        if weights_normalization == 'sn':
            conv_layer = SpectralNormalization(Conv2D(channels, kernel_size, stride, padding='same', kernel_initializer=tf.initializers.orthogonal()))
        else:
            conv_layer = Conv2D(channels, kernel_size, stride, padding='same', kernel_initializer=tf.initializers.orthogonal())
...
class TripleTConv(Layer):
    def __init__(self, channels, kernel_size, stride, weights_normalization=None, normalization=None, activation=None):
        ...
        self.layers = []
        if weights_normalization == 'sn':
            conv_layer = SpectralNormalization(Conv2DTranspose(channels, kernel_size, stride, padding='same', kernel_initializer=tf.initializers.orthogonal()))
        else:
            conv_layer = Conv2DTranspose(channels, kernel_size, stride, padding='same', kernel_initializer=tf.initializers.orthogonal())
...
class TripleDense(Layer):
    def __init__(self, size, weights_normalization, normalization, activation):
        ...
        self.layers = []
        if weights_normalization == 'sn':
            dense_layer = SpectralNormalization(Dense(size, kernel_initializer=tf.initializers.orthogonal()))
        else:
            dense_layer = Dense(size, kernel_initializer=tf.initializers.orthogonal())
